...
2. Go to **Allfiles/20486C/Mod14/Labfiles/PhotoSharingApplication_14_begin/PhotoSharingApplication**, and then paste the **web.config** file.  
...
7. In the **Add Existing Item – PhotoSharingApplication** dialog box, navigate to **Allfiles/20486C/Labfiles/Mod14/Chat View**, click **Chat.cshtml**, and then click **Add**.
