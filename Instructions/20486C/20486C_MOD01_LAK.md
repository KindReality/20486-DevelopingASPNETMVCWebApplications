...
2. In the **Open Project** dialog box, navigate to **c:\Allfiles\20486C\Mod01\Labfiles\PhotoSharingSample**, click **PhotoSharingSample.sln**, and then click **Open**.
...
3. In the left pane of the **New Project** dialog box, expand **Installed**, and then expand **Visual C#\Web\Web Site**.
4. Under Visual C#, click **Web**, click **Web Site**, and then, in the result pane, click **ASP.NET Web Site (Razor v3)**.
5. On the **DEBUG** menu of the **Microsoft Visual Studio** window, click **Start Debugging**.
...
1. In the Solution Explorer pane, expand **Views**.
