...
2. On the **Welcome to Adventure Works Photo Sharing! Use this site to share your adventures** page, right-click **Display** corresponding to any image, and then click **Inspect Element**.
