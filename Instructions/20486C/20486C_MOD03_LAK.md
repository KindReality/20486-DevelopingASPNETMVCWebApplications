...
6. In the **Location** text box, ensure that the location specified is **C:\Allfiles\20486C\Mod03\Labfiles**.
...
11. In a new line of the **PhotoSharingInitializer** class, type "override", press the spacebar, and then click **Seed(PhotoSharingContext context)** that appears.
...
9. In the **Resource group** box, type **MyResourceGroup**.
...
22. Click **Show database connection strings**. 
