...
2. In the Solution Explorer pane, right-click **Views\Shared**, and then click **Paste**.
3. Under **Views\Shared**, right-click **_MainLayout - Copy.cshtml**, click **Rename**, type **_MainLayout.Mobile**, and then press Enter.
...
```
3. In the **PhotoSharingStyles.css** code window, locate the following code. Copy the rule.
...
```
4. In the **PhotoSharingStyles.css** code window, place the cursor in the media query you just added, and paste the previous rule.
