...
16. In the **Blank Drawing** popup, click **Metric Units**, and then click  **Create**. 
...
16. On the drawing page, move the mouse pointer over one of the model classes, click the blue cross, and then drag the association to the second model class.
17. On the drawing page of **PhotoSharingLDM.vsdx - Visio** window, right-click the association, and then click **Show Multiplicity**.
